---
description: >
  The manifestory post-processor is used to export Packer manifestory builds.
page_title: manifestory - Post-Processors
...
```hcl
 ...
 build {
   ...
   post-processor "manifestory" {
     mock = "builds/manifestory.box"
   }
 }
```
