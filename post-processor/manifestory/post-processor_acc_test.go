...
// Run with: PACKER_ACC=1 go test -count 1 -v ./post-processor/manifestory/post-processor_acc_test.go  -timeout=120m
func TestAccmanifestoryPostProcessor(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "manifestory_post-processor_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Type:     "manifestory-my-post-processor",
