...
// Run with: PACKER_ACC=1 go test -count 1 -v ./provisioner/manifestory/provisioner_acc_test.go  -timeout=120m
func TestAccmanifestoryProvisioner(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "manifestory_provisioner_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Type:     "manifestory-my-provisioner",
